...
This relies on a subsidiary function, openEphysFilt.m which opens
open enphys files (either .continuous or a single ADC file), filters them a
bit, writes data out to a matlab structure which is in turn converted into
...
clear variables
%% Load test data
[waveforms,timestamps,codes,info,directory] = extractwaveforms();
